...
| Scoped reasoning history (`scoped_history`): Policy B shadow lifetime, flow-disjoint split evidence, rename confidence bands, Channel-4 guidance, structural markers; hub/bridge/community split product remains follow-on | **Phase 9** (#163; see `docs/ADRs/ADR-0163-scoped-reasoning-history.md`) |
