...
- [ ] **[Feature] Incremental Commit Generation with Delta Diffs and Caching**
  ...
  - **Implementation**: The prompt becomes: *"Here is your previously generated draft commit message. The user has made the following minor tweaks since then (Delta Diff). Please update the draft message to incorporate these minor changes."*
