...
- [ ] For attribution purposes, review the [MTPLX License, citation and attribution](https://github.com/youssofal/MTPLX#license-citation-and-attribution) and ensure compliance, allong with the projects cited by MTPLX itself (although that could get long attributing each attributed tools own attributions, it would cascasde. What are your thoughts?).
...
- [ ] Explore integrating [GitLeaks](https://github.com/gitleaks/gitleaks) or [TruffleHog](https://github.com/trufflesecurity/trufflehog) or [BetterLeaks](https://github.com/betterleaks/betterleaks)
