...
╭─ Arguments ──────────────────────────────────────────────────────────────────╮
│   commit_msg_file      [COMMIT_MSG_FILE]  Path to the commit message file    │
│                                           [default: .git/COMMIT_EDITMSG]     │
│   commit_source        [COMMIT_SOURCE]    Source of the commit message       │
│                                           (e.g., 'message', 'template', or   │
│                                           empty for default generation)      │
│   extra_args           [EXTRA_ARGS]...    Any extra arguments passed by git  │
│                                           hooks                              │
╰──────────────────────────────────────────────────────────────────────────────╯
╭─ Options ────────────────────────────────────────────────────────────────────╮
│ --engine            -e                          TEXT  AI engine to use (e.g. │
│                                                       omlx, mtplx)           │
│                                                       [default: mtplx]       │
│ --dry-run           -d                                Do not write the       │
│                                                       commit message, just   │
│                                                       print it               │
│ --verbose           -v                                Enable verbose output  │
│ --amend-regenerate                                    Opt in to regenerating │
│                                                       the message on git     │
│                                                       --amend (source        │
│                                                       'commit'). Off by      │
│                                                       default.               │
│ --strict                                              Exit non-zero on       │
│                                                       failure. Leave OFF for │
│                                                       git hooks so a failed  │
│                                                       generation never       │
│                                                       blocks the commit;     │
│                                                       turn ON for CLI/CI     │
│                                                       use.                   │
...
│                                                       ($VISUAL) when editing │
│                                                       commit messages.       │
│ --enable-semantic       --no-enable-semantic          Enable Phase 1         │
│                                                       semantic producers     │
│                                                       (default:              │
