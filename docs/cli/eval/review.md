...
Usage: git-cg eval review [OPTIONS] COMMAND [ARGS]...
 ...
 Manage advisory human-review items for eval cases. Never writes gold or changes product commit ranking.
...
│ adjudicate  Adjudicate an in_review item (emits typed outcome_ref; never writes gold).                               │
...
* [`git-cg eval review rollup`](review/rollup.md) — Roll up multi-rater advisory scores for review items.
