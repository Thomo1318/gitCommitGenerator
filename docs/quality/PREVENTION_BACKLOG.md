...
|:---|:---|:---|:---|:---|:---|:---|
| **P-S12-1** | If `presentation_fallback_reason != none` **or** body matches skeleton/fallback templates, gold-strict **must fail** (`GOLD_FALLBACK_NOT_FINAL`). | F72 | open/partial | #204 | `commit_gold` / gold_strict | [S12-G1](./cases/204/session-12.md) |
...
| **P-S12-9** | Message-only rebuild: disable prepare git-cg. `--no-verify` alone insufficient. `core.hooksPath=/dev/null` may be **insufficient under hk** — prefer `git commit-tree` or a skip flag hk+git-cg both honour (`GIT_CG_SKIP_PREPARE=1` when wired). | F80 | process doc strengthened; product/hk skip still TBD | #204 | [`process/message-only-rewrite.md`](./process/message-only-rewrite.md) | [S12 synth](./cases/204/session-12-synthesis.md) + [204-QP-RB](./cases/204/quality-package-regime-b.md) |
