...
> New cases **must** use [`../templates/CASE_TEMPLATE.md`](../templates/CASE_TEMPLATE.md) and pass [`../METHOD.md`](../METHOD.md) §12.

| Case | Issue | Series class | Regime | Depth | Path | Status |
|:---|:---|:---|:---|:---|:---|:---|
| 204 epic map | #204 | mixed | — | index | [`204/README.md`](./204/README.md) | active |
| Instance A precursor | #204 | precursor | mostly B-class content | stub target | [`204/instance-a-precursor.md`](./204/instance-a-precursor.md) | stub |
...
1. One primary tip per file unless a short pair shares one Opik window and stays reviewable.  
2. Multi-group systems close-out → synthesis file.  
3. Update this table on every promote.  
4. Link F*/P* registries when IDs appear.
