# Source map — GitHub comments → package paths

> Package version: `1.0.0-combine`  
> Issue: https://github.com/Thomo1318/gitCommitGenerator/issues/204

| Comment ID | Role | Package target | Promote status |
|:---|:---|:---|:---|
| body | Law · V12-A · anti-patterns | `GOLD_STANDARD.md` · `CORPUS.md` | partial mirror |
...
| Ref | Role | Package target |
|:---|:---|:---|
| #204 issue | corpus epic / intake host | `cases/204/**` + law docs — body still partial mirror |
| #217 / eval plan | consumer of F72–F80 + session-12-seed + regimes | [`docs/plans/opik-evaluation-harness.md`](../../plans/opik-evaluation-harness.md) · issue = governance index only |
| #220 | first forward case | `cases/220/s0-schema-freeze.md` |

## After promote

Add comment header: superseded as SSOT by `docs/quality/...`.
