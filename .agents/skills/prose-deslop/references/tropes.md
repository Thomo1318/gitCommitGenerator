...
### Tech Puffery & Empty Superlatives

Littering engineering specifications, ADRs, or technical summaries with ungrounded marketing superlatives. AI uses these words as a substitute for real engineering data, metrics, or architecture details.

**Avoid patterns like:**

- "a blazing-fast, rock-solid caching tier"
- "a groundbreaking and battle-tested architecture"
- "enables effortless integration with cutting-edge models"

### False Concessions

Simulated humility, hesitation, or rhetorical throat-clearing before stating a technical critique or decision.

**Avoid patterns like:**

- "To be fair, the original design had good intentions, but..."
- "Admittedly, this tradeoff is difficult, but we must..."
- "While it is certainly true that SQLite is popular..."

### Synonym Cycling (The Elegant Variation Trap)

Artificially alternating between synonyms within the same paragraph to avoid word repetition. In technical documentation, this introduces ambiguity because readers wonder if different terms refer to distinct components.

**Avoid patterns like:**

- "The client sends a request... The caller awaits the response... The consumer handles errors."
- "The module parses input... The utility formats data... The helper validates tokens."

### Inflated Super-Verbs

Using dramatic action verbs for mundane engineering steps.

**Avoid patterns like:**

- "spearheading the migration to TypeScript"
- "orchestrating the cleanup of temp files"
- "democratizing data access across services"
- "supercharging test execution speeds"
