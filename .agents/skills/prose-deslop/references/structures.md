...
## Plan and Review Meta-Artifact Shorthand

Treating ephemeral plan steps, review indices, or ticket markers as domain concepts.

| Pattern                            | Problem                                                     |
| ---------------------------------- | ----------------------------------------------------------- |
| "Addresses finding 6"              | Ephemeral review index loses all meaning outside the review |
| "Per step 3 of the plan"           | Plan steps are transient; code and docs are permanent       |
| "Resolves item 4 in the checklist" | Forces readers to excavate archived conversations           |

**Fix:** Name the concrete problem, invariant, or architectural decision directly.

## Conversational Scaffolding

Prefixing documents, ADRs, or PR descriptions with conversational lead-ins.

| Pattern                                        | Problem                                      |
| ---------------------------------------------- | -------------------------------------------- |
| "Certainly! Below is the updated document:"    | Chatbot preamble leaking into permanent docs |
| "Here is the summary of changes as requested:" | Conversational residue                       |
| "In this PR, we have implemented..."           | Filler transition                            |

## False Concessions

Simulated humility and rhetorical stagecraft before pivoting to an argument.

| Pattern                             | Problem                                       |
| ----------------------------------- | --------------------------------------------- |
| "To be fair, [X] has merit, but..." | Performative hesitation before making a point |
| "Admittedly, this is complex..."    | Rhetorical stagecraft                         |
| "While it's certainly true that..." | Wordy concessive runway                       |

**Fix:** State the tradeoff or boundary condition directly without preamble.

## Tech Puffery Superlatives

Inflating technical capabilities with marketing buzzwords instead of technical data.

| Pattern                                        | Problem                                     |
| ---------------------------------------------- | ------------------------------------------- |
| "Provides a blazing-fast, rock-solid cache"    | Hollow adjectives without empirical meaning |
| "A battle-tested, groundbreaking architecture" | Hype language in engineering specs          |

**Fix:** State concrete performance numbers, test invariants, or architectural patterns.

## Synonym Cycling (The Elegant Variation Trap)

Rotating synonyms for the same entity across adjacent sentences to avoid repetition.

| Pattern                                                        | Problem                                              |
| -------------------------------------------------------------- | ---------------------------------------------------- |
| "The client calls X... The consumer receives Y... The caller Z" | Creates false ambiguity about whether entities differ |
| "This tool does A... The framework does B... The platform C"   | Artificial noun inflation                            |

**Fix:** Pick the single canonical domain term and repeat it cleanly.

## Mid-Sentence Colon Crutch & Parenthetical Stacking

Using colons or parentheticals as mid-sentence drama pivots.
